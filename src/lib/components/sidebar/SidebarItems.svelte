<script>
	...
	const style = {
		...
		active: `bg-white hover:bg-white flex items-center text-black  rounded-md m-2`,
		link: `flex items-center hover:bg-neutral-200/50 rounded-md m-2 justify-start my-1 whitespace-pre`,
