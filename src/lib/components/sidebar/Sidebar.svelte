<script lang="ts">
	...
	const style = {
		...
		default: `sidebar z-50 shadow-xl bg-indigo-500 dark:bg-indigo-900 dark:text-dark-text h-screen overflow-y-auto text-white top-0 lg:block fixed rounded-none ease-in-out  transition-all`
	};
